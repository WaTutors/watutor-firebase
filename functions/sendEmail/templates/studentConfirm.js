                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tbody>
                                          <tr>
                                            <td valign="top">
                                              <img
                                                src="https://firebasestorage.googleapis.com/v0/b/wa-tutors.appspot.com/o/public%2Fschedule.svg?alt=media"
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td class="pc-fb-font"
                                              style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 300; line-height: 22px; letter-spacing: -0.2px; color: #9B9B9B;"
                                              valign="top">
                                              Grade: ###GRADE###
                                              <br>
                                              Subject: ###SUBJECT###
                                            ...
                                            <td style="padding: 20px;" valign="top">
                                              <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td class="pc-fb-font"
                                                      style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 500; line-height: 50px; letter-spacing: -0.2px; color: #1B1B1B; "
                                                      valign="top">
                                                      ###TUTORNAME###
                                                    </td>
                                                  </tr>
                                                          ...
                                                          <td style="padding: 20px;" valign="top">
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                              ...
                                                              <tbody>
                                                                <tr>
                                                                  <td
                                                                    style="font-family: Arial, sans-serif; font-size: 19px; text-align:right"
                                                                    valign="top">
                                                                    <a href="###FB_LOGOLINK###"
                                                                      style="text-decoration: none;"><img
                                                                        src="https://firebasestorage.googleapis.com/v0/b/wa-tutors.appspot.com/o/public%2FTransparent%20Icon.png?alt=media"
                                                                        width="50" alt=""
                                                              ...
                                                              <tbody>
                                                                <tr>
                                                                  <td class="pc-fb-font"
                                                                    ...
                                                                    valign="top">
                                                                    <a href="tel:###CONTACT_US_PHONE###"
                                                                      style="text-decoration: none; color: #ffffff;">###CONTACT_US_PHONE###</a>
                                                                  </td>
                                                                </tr>
                                                                <tr>
                                                                  <td height="9"
                                                                ...
                                                                <tr>
                                                                  <td class="pc-fb-font"
                                                                    ...
                                                                    <a href="mailto:###CONTACT_US_EMAIL###"
                                                                      style="text-decoration: none; color: #1595E7;">
                                                                      ###CONTACT_US_EMAIL###
                                                                    </a>
                                                                  </td>
                                                                </tr>
